...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory('driveguard_navigation2'),
            'maps',
            'room.yaml'))

    param_file_name = 'nav2_neo_params.yaml'
    ...
    nav2_launch_file_dir = os.path.join(get_package_share_directory('driveguard_navigation2'), 'launch')
    rviz_config_dir = os.path.join(get_package_share_directory('driveguard_navigation2'), 'rviz', 'driveguard_default_view.rviz')
