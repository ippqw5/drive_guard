...
def get_scan_count():
    ...
    tree = ET.parse(base_path + '/src/turtlebot3_simulations/turtlebot3_gazebo/models/turtlebot3_burger/model.sdf')
...
def get_simulation_speed(stage):
    ...
    tree = ET.parse(base_path + '/src/turtlebot3_simulations/turtlebot3_gazebo/worlds/turtlebot3_drl_stage' + str(stage) + '/burger.model')
    root = tree.getroot()
